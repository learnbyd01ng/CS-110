...
/**
 * Adds the appropriate "x-forwarded-proto" and
 * "x-forwarded-for" headers.
 */
  void addHeaders(std::string clientIPAddress);
...
/**
 * Returns true if there is a cycle of proxy servers attempting to
 * forward to one another.
 */
  bool containsCycle(const std::string& clientIPAddress);

/**
 * The next eight methods are all const, inlined accessors.
